...
# res = 0
# while True:
#     test1 = txt2 + base_str_2.encode() + str(i).encode()
#     test2 = txt2 + str(i).encode() + base_str_2.encode()
#     test3 = str(i).encode() + txt2 + base_str_2.encode()
#     if hashlib.md5(txt1).digest() == hashlib.md5(test1).digest() :
#         txt2 = test1
#         break
#     if hashlib.md5(txt1).digest() == hashlib.md5(test2).digest() :
#         txt2 = test2
#         break
#     if hashlib.md5(txt1).digest() == hashlib.md5(test3).digest() :
#         txt2 = test3
#         break
#     i += 1
# 
# print(txt1)
# print(txt2)
# print(hashlib.md5(txt1).digest())
# print(hashlib.md5(txt2).digest())


print(base64.b64encode(txt1))

# io = remote('byuctf.xyz', 40016)
# io.sendline(base64.b64encode(txt1))
# io.sendline(base64.b64encode(txt1))
# 
# io.interactive()
